...
un environnement modéré, des algorithmes locaux (interpolation dans
l'espace articulaire avec vérification de collision) suffisent dans un premier
temps ; RRT est envisagé comme extension pour la replanification en présence
d'obstacles.
